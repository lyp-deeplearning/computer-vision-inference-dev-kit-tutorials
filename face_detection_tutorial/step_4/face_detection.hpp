...
static const char mHP16[] = MOD2PATH("head-pose-estimation-adas-0001", FP16);
static const char mHP32[] = MOD2PATH("head-pose-estimation-adas-0001", FP32);
...
DEFINE_string(mHP32, mHP32, model_path_message);
DEFINE_string(mHP16, mHP16, model_path_message);
...
static const char head_pose_model_message[] = "Path to an .xml file with a trained head pose model";
...
/// @brief message for number of simultaneously age gender detections using dynamic batch
static const char num_batch_hp_message[] = "Specify number of maximum simultaneously processed faces for Head Pose Detection";
...
/// \brief Define parameter for face detection  model file <br>
/// It is a required parameter
DEFINE_string(m_hp, mHP32, head_pose_model_message);
...
DEFINE_string(d_hp, "GPU", target_device_message_hp);
