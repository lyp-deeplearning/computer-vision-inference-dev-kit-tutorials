...
2. The opencv.hpp file is included for the Intel® optimized OpenCV libraries included in the Intel® Distribution of Intel® Distribution of OpenVINO™ toolkit.
